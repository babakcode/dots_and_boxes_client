...
class LineHorizontalPainter extends CustomPainter {
  final double progress;
  final Color color;

  const LineHorizontalPainter(this.progress, this.color);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final List<Offset> points = [
      Offset(size.width * .01, size.height * .4),
      Offset(size.width * .95, size.height * .6),
      Offset(size.width * .05, size.height * .5),
      Offset(size.width * .99, size.height * .5),
      Offset(size.width * .13, size.height * .72),
    ];
