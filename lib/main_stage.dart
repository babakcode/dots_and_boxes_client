...
class _StageMockWidgetState extends State<_StageMockWidget> {
  ...
  Future<void> _verifyDotsBoxes() async {
    await context
        ...
        .verifyDotsBoxes(
      platform: 'weba',
      initData: 'user=%7B%22id%22%3A31000032%2C%22first_name%22%3A%22BabakTest%22%2C%22last_name%22%3A%22Gahremanzadeh%22%2C%22username%22%3A%22BabakCode%22%2C%22language_code%22%3A%22en%22%2C%22allows_write_to_pm%22%3Atrue%7D&chat_instance=338584334934182876&chat_type=sender&auth_date=1726927328&hash=fae02085891486658f9e89eac9f5775ec5ef9bd9a5f80aab3edf724a81b2129b',
    )
        .then(
          (value) {
